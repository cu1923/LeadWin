...
const subjects = ["Spanish", "Coding", "Speech/Debate", "Art"]
      ...
      <AnimationRevealPage>
        ...
        <Element name="Spanish">
            <Programs
                ...
                heading = {(
                    <>
                    <span tw="text-primary-400"> Spanish </span>
                    </>
                )}
                features = {[[]]}
                imageSrc=""
        ...
        <Element name="Speech/Debate">
            <Programs
                subheading = {''}
                heading = {(
                    <>
                    <span tw="text-primary-400"> Speech/Debate </span>
                    </>
                )}
                features = {[[]]}
                imageSrc=""
