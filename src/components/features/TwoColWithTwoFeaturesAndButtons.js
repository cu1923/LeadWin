...
const FeatureIconContainer = styled.div`
  ...
  svg {
    ${tw`w-5 h-5 text-primary-400`}
  }
`;

const FeatureText = tw.div`mt-4 md:mt-0 md:ml-4 text-center md:text-left`;
const FeatureHeading = tw.div`font-bold text-lg text-primary-400`;
...
export default ({
  ...
  heading = (
    <>
      We have the most <span tw="text-primary-400">professional</span> marketing team.
    </>
  ),
