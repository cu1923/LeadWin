...
const DecoratorBlob = tw(
  SvgDotPattern
)`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-primary-400 -z-10`;
...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-primary-400">Professionals.</span>
    </>
  ),
