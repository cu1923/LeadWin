...
const Link = tw.a`inline-block mt-2 text-sm text-primary-400 font-bold cursor-pointer transition duration-300 border-b-2 border-transparent hover:border-primary-500`;
